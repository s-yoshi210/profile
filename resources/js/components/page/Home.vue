          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <table class="table text-center">
                <tr>
                  <th>GitHub</th>
                  <td><a :href="profile.git_url">{{ profile.git_account }}</a></td>
                </tr>
                <tr>
                  <th>Twitter</th>
                  <td><a :href="profile.twitter_url">{{ profile.twitter_account }}</a></td>
                </tr>
                <tr>
                  <th>Qiita</th>
                  <td><a :href="profile.qiita_url">{{ profile.qiita_account }}</a></td>
                </tr>
              </table>
            </div>
          </div>
